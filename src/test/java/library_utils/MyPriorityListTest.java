...
class MyPriorityListTest {
    ...
    MyPriorityList list = null;

    @BeforeEach
    void setUp() {
        list = new MyPriorityList();
        try{
    ...
    @Test
    @DisplayName("Test remove method to ensure it removes orders the first come first serve and priority criteria")
